...
CONFLUENCE_CQLS_3_LETTERS = __get_confluence_dataset('cqls_3_letters.csv')
CONFLUENCE_CQLS_4_LETTERS = __get_confluence_dataset('cqls_4_letters.csv')
CONFLUENCE_CQLS_5_LETTERS = __get_confluence_dataset('cqls_5_letters.csv')
