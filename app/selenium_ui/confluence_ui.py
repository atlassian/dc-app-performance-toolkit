...
def test_1_selenium_edit_page_click_edit(confluence_webdriver, confluence_datasets, confluence_screen_shots):
    modules.edit_confluence_page_click_edit(confluence_webdriver, confluence_datasets)
