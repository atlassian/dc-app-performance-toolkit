...
def test_1_selenium_custom_view_page(confluence_webdriver, confluence_datasets, confluence_screen_shots):
    extension_ui.view_page_custom_page(confluence_webdriver, confluence_datasets)

def test_1_selenium_custom_edit_page(confluence_webdriver, confluence_datasets, confluence_screen_shots):
    extension_ui.edit_confluence_page(confluence_webdriver, confluence_datasets)
