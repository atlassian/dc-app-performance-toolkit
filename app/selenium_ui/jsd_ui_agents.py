...
#     modules_agents.view_queue_all_open_large_project(jsd_webdriver, jsd_datasets)
#
#
# def test_1_selenium_view_queue_all_open_small_project(jsd_webdriver, jsd_datasets, jsd_screen_shots):
#     modules_agents.view_queue_all_open_small_project(jsd_webdriver, jsd_datasets)


def test_1_selenium_view_queue_random_large_project(jsd_webdriver, jsd_datasets, jsd_screen_shots):
    modules_agents.view_queue_random_small_project(jsd_webdriver, jsd_datasets)
