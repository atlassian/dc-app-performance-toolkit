...
from selenium_ui.jsd.pages.agent_selectors import LoginPageLocators, PopupLocators, DashboardLocators, LogoutLocators, \
    BrowseServiceDeskProjectsLocators, BrowseCustomersLocators, ViewCustomerRequestLocators, UrlManager, \
    ViewReportsLocators, ViewQueueLocators
...
class BrowseServiceDeskProjects(BasePage):
    page_url = BrowseServiceDeskProjectsLocators.brows_projects_url

    def wait_for_page_loaded(self):
        self.wait_until_visible(BrowseServiceDeskProjectsLocators.page_title)
