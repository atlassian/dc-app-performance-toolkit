...
from util.project_paths import JIRA_DATASET_ISSUES, JIRA_DATASET_JQLS, JIRA_DATASET_KANBAN_BOARDS, \
    ...
    JSM_DATASET_INSIGHT_SCHEMAS, JSM_DATASET_INSIGHT_ISSUES, BAMBOO_USERS, BAMBOO_BUILD_PLANS, CONFLUENCE_CQLS_3_LETTERS, \
...
class Dataset:
    ...
    def confluence_dataset(self):
        if not self.dataset:
            ...
            self.dataset["cqls_3_letters"] = self.__read_input_file(CONFLUENCE_CQLS_3_LETTERS)
            self.dataset["cqls_4_letters"] = self.__read_input_file(CONFLUENCE_CQLS_4_LETTERS)
            self.dataset["cqls_5_letters"] = self.__read_input_file(CONFLUENCE_CQLS_5_LETTERS)
