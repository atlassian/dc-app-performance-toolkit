...
def zdu_nodes_info(confluence_webdriver, tmp_path_factory):
    ...
    # print("loading login_page")
    # started_at = time.time_ns()
    # print(started_at)
    # # login_page = Login(confluence_webdriver)
    # # login_page.go_to()
    # # login_page.wait_for_page_loaded()
    # # node_id = confluence_webdriver.page_source
    # print(node_id, " ", confluence_webdriver.node_ip)
    # print(f"finished at {time.time_ns() - started_at}")
