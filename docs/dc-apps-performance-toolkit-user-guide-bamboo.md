...
#### Generating a Bamboo performance regression report with TUI tool (beta)
...
8. Open "Bamboo report" sub-tab and set previously downloaded test runs according to description of fields.
