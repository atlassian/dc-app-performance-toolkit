...
| Version | The Data Center App Performance Toolkit officially supports `8.13.0`, `8.5.10` ([Long Term Support release](https://confluence.atlassian.com/enterprise/atlassian-enterprise-releases-948227420.html)) and `8.0.3` Platform Release |
