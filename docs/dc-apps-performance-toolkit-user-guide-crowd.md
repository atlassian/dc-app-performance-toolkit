...
| --------- | ----------------- |
| Version | The Data Center App Performance Toolkit officially supports `4.3.5` ([Long Term Support release](https://confluence.atlassian.com/crowd/crowd-release-notes-199094.html)) |
