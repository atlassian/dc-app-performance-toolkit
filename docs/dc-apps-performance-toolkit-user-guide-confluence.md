...
7. Optional variables to override:
   ...
   - Make sure that the Confluence version specified in **confluence_version_tag** is consistent with the EBS and RDS snapshot versions. Additionally, ensure that the snapshot lines are uncommented.
