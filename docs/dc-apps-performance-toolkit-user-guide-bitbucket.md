...
| --------- | ----------------- |
| Version | The Data Center App Performance Toolkit officially supports `6.10.5` and `7.6.0` ([Long Term Support releases](https://confluence.atlassian.com/enterprise/atlassian-enterprise-releases-948227420.html)) or `7.0.5` Platform Release |
