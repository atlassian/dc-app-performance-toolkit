...
7. Optional variables to override:
   ...
   - Make sure that the Bitbucket version specified in **bitbucket_version_tag** is consistent with the EBS and RDS snapshot versions. Additionally, ensure that the snapshot lines are uncommented.
